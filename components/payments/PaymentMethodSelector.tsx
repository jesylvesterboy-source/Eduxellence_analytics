  ...
  function payWithPaystack() {
    ...
    const handler = w.PaystackPop.setup({
      ...
      metadata: {
        ...
        project_id: projectId,
        milestone_id: milestoneId ?? null,
        // IMPORTANT: this must be amountNgn / 100 — the exact NGN value
        // Paystack actually charges and will report back on verify — NOT
        // amountUsd. A previous version of this file mistakenly used
        // amountUsd here, which caused every Paystack payment to fail
        // the central router's amount-match check.
