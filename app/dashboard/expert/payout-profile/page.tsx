    ...
    <div style={{ minHeight: "100vh", background: "var(--cream)", padding: "2rem 5%" }}>
      <div style={{ maxWidth: "560px", margin: "0 auto" }}>
        ...
        {!pendingProfile && (
          <>
            {!showForm ? (
              <button onClick={() => setShowForm(true)} style={{ background: "var(--ink)", color: "var(--white)", border: "none", padding: "0.7rem 1.5rem", borderRadius: "6px", fontWeight: 600, cursor: "pointer" }}>
              ...
              <div style={{ background: "var(--white)", border: "1px solid var(--border)", borderRadius: "10px", padding: "1.5rem" }}>
                ...
                <div style={{ display: "flex", gap: "0.6rem", marginTop: "0.5rem" }}>
                  ...
                  <button onClick={() => setShowForm(false)} style={{ background: "var(--cream-dark)", border: "1px solid var(--border)", padding: "0.6rem 1.25rem", borderRadius: "6px", cursor: "pointer" }}>
                    Cancel
                  </button>
                </div>
              </div>
